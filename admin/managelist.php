...
<h1 style="font-weight: bold; font-size: 170%; margin-bottom: 1ch;"><?php echo esc_html(__('Podcast Network', 'empowercast-network'));?></h1>
<h4 style="margin: 0; font-size: 120%;"><?php echo esc_html(__('Build and manage your podcast network.','empowercast-network'));?></h4><br>
...
<div class="settingBox">
    <form method="POST" action="#/" id="<?php echo $new_group ? 'createForm' : 'editForm'; ?>"> <!-- Make sure to keep back slash there for WordPress -->
        ...
        <h4 style="margin-top: 1ch"><?php echo esc_html(__('Group shows together and showcase them on one page.', 'empowercast-network'));?></h4>
        <h4 style="font-weight: bold;margin: 1ch 0;"><?php echo esc_html(__('Group Name', 'empowercast-network'));?></h4>
        ...
        <h4 style="font-weight: bold;margin: 1ch 0;"><?php echo esc_html(__('Group Description', 'empowercast-network'));?></h4>
        ...
        <div id ="programBox" style="display: none">
            <h4 style="font-size: 115%; margin: 1ch 0;"><?php echo __('Add Shows', 'empowercast'); ?></h4>
                ...
                <a class="ppn-done-link" href="" onclick="tb_remove();return false;"><?php echo esc_html(__('Done', 'empowercast-network'));?></a>
        </div>
        <?php if (!$new_group) { ?>
...
<!--List Page Section-->
    <?php if (!$new_group) { ?>
        <h4 style="font-weight: bold;margin: 1ch 0;"><?php echo __('Group Page Link', 'empowercast-network'); ?></h4>
        <?php
        if (!empty($networkInfo['link_page_list'])) {
            ...
            <a href="#TB_inline?&width=500&height=300&inlineId=selectPageBox" class="thickbox"
               title="Empowercast Network plugin"><?php echo esc_html(__('CHANGE PAGE', 'empowercast-network')); ?></a> &nbsp; &nbsp;
            <a style="color: #D21919;" href="#TB_inline?&width=600&height=200&inlineId=confirmUnlink" class="thickbox"
               title="Empowercast Network plugin"><?php echo esc_html(__('UNLINK PAGE', 'empowercast-network')); ?></a>
            <?php
            ...
            <a href="#TB_inline?&width=500&height=300&inlineId=selectPageBox" class="thickbox"
               title="Empowercast Network plugin"><?php echo esc_html(__('SELECT PAGE', 'empowercast-network')); ?></a> &nbsp; &nbsp;
            <a href=""
               onclick="createPage('<?php echo esc_html($networkInfo['list_id']); ?>', 'List', 'createForm', '<?php echo esc_html($props['list_info']['list_title']); ?>'); return false;"><?php echo esc_html(__('CREATE PAGE', 'empowercast-network')); ?></a>
...
<div id="selectPageBox" style="display: none">
    ...
    <button type="submit" class="ppn-back-button" onclick="directStatus('Manage List', 'pageForm', true)"><?php echo esc_html(__('Save', 'empowercast-network'));?></button>
...
<div class="confirmUnlink" id="confirmUnlink" style="display: none">
    ...
    <button type="submit" class="warningButton" onclick="confirmUnlink('unlinkForm');directStatus('Manage List', 'unlinkForm', 'groups')"><?php echo esc_html(__('Unlink page', 'empowercast-network'));?></button>
    <p class="ppn-back-button" onclick="tb_remove();"><?php echo esc_html(__('Cancel', 'empowercast-network'));?></p>
</div>
<!--Program Section-->
    <div class="settingBox" style="float: right;">
        <div class="top-right-corner right-margin-responsive">
        <a href="<?php echo admin_url("admin.php?page=". urlencode(empowercast_admin_get_page()) ."&status=Select+Choice&tab=groups"); ?>">
            <?php echo esc_html(__('BACK', 'empowercast-network'));?></a>
        <button type="submit" class="cacheButton" style="font-size: 90%; margin-left: 2em;" onclick="directStatus('Manage List', '<?php echo $new_group ? 'createForm' : 'editForm'; ?>', true)"><?php echo esc_html(__('SAVE GROUP', 'empowercast-network'));?></button>
        </div>
<?php if (!$new_group) { ?>
<div class="settingBox" style="margin-top: 1em;">
    <h4 style="font-weight: bold; margin-bottom: 0; margin-top: 1ch;"><?php echo esc_html(__('Shows in Group', 'empowercast-network'));?></h4>
    ...
    <a href="#TB_inline?&width=500&height=300&inlineId=programBox&modal=true" class="thickbox" title="Empowercast Network plugin">ADD SHOWS</a>
