...
<form id ='createForm' method="POST">
    ...
    <a class="warningButton" href="<?php echo admin_url("admin.php?page=". urlencode(empowercast_admin_get_page()) ."&status=List+Applicants"); ?>">
    <p><?php echo '&#8592 ' . esc_html(__('Cancel', 'empowercast-network'));?></p></a>
    <div id="addInfo">
        ...
        <a class="warningButton" href="<?php echo admin_url("admin.php?page=". urlencode(empowercast_admin_get_page()) ."&status=List+Applicants"); ?>">
        <p><?php echo __('&#8592; Cancel', 'empowercast-network');?></p></a>
    </div>
</form>
