<h2 style="font-weight: bold; font-size: 150%; margin-bottom: 1ch;"><?php echo esc_html(get_option('empowercast_network_title') ) . ' Groups'; ?>
    <button onclick='manageList(-1);directStatus("Create List", "manageForm");' class="cacheButton top-right-corner"><?php echo esc_html(__('CREATE NEW GROUP', 'empowercast-network'));?></button>

</h2>
<h4 style="margin: 0; font-size: 120%;"><?php echo esc_html(__('Manage the lists in your network by controlling which programs are in them.', 'empowercast-network'));?></h4><br>
<table>
    <thead>
    <tr>
        <th style="text-align: left;"><?php echo esc_html(__('Current Groups', 'empowercast-network'));?></th>

        <th style="text-align: left;"><?php echo esc_html(__('Link', 'empowercast-network'));?></th>

        <th style="text-align: left;"><?php echo esc_html(__('Group ID', 'empowercast-network'));?></th>

        <th style="text-align: left;"><?php echo esc_html(__('Manage', 'empowercast-network'));?></th>
    </tr>
    </thead>
    <?php

    $map = get_option ('empowercast_network_map');
	if( empty($props) )
        ...
        <tr>
            ...
            <td class="<?php echo $class; ?>">
                    ...
                    if ($props[$i]['link'] == null){
                        ...
                        ?>
                        <span style="font-weight:bold;"><a style="color: green;" target="_blank" href="<?php echo esc_url($props[$i]['link']);?>"><?php echo esc_html(__('View Page', 'empowercast-network'));?></a></span>
                        <?php
                    }
                    ?>
            </td>
...
<script>
    ...
    {
        if (confirm('<?php echo esc_js(__('Are you sure you want to delete this list?', 'empowercast-network'));?>')) { //Confirm the delete network
