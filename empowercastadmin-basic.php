...
function empowercast_admin_basic()
{
    if (defined('WP_DEBUG')) {
        if (WP_DEBUG) {
	...
	$CustomFeed = get_option('empowercast_feed_'.'podcast', array()); // Get the custom podcast feed settings saved in the database
	if( !empty($CustomFeed) ) // If they enabled custom podast channels...
	{
		$FeedSettings = empowercast_merge_empty_feed_settings($CustomFeed, $FeedSettings);
...
<input type="hidden" name="action" value="empowercast-save-settings" />
...
<div id="empowercast_settings_page" class="empowercast_tabbed_content">
    <div class="pp-tab">
        <button id="welcome-tab" class="tablinks active" onclick="empowercast_openTab(event, 'settings-welcome')"><?php echo htmlspecialchars(__('Welcome', 'empowercast')); ?></button>
        <!-- #tab1 deprecated. was episodes tab -->
        <button id="feeds-tab" class="tablinks" onclick="empowercast_openTab(event, 'settings-feeds')"><?php echo htmlspecialchars(__('Feeds', 'empowercast')); ?></button>
        <button id="website-tab" class="tablinks" onclick="empowercast_openTab(event, 'settings-website')"><?php echo htmlspecialchars(__('Website', 'empowercast')); ?></button>
        <button id="destinations-tab" class="tablinks" onclick="empowercast_openTab(event, 'settings-destinations')"><?php echo htmlspecialchars(__('Destinations', 'empowercast')); ?></button>
        <!-- <button id="analytics-tab" class="tablinks" onclick="openTab(event, 'settings-analytics')"><?php echo htmlspecialchars(__('Analytics', 'empowercast')); ?></button> -->
        <button id="advanced-tab" class="tablinks" onclick="empowercast_openTab(event, 'settings-advanced')"><?php echo htmlspecialchars(__('Advanced', 'empowercast')); ?></button>
        <button id="make-money-tab" class="tablinks" onclick="empowercast_openTab(event, 'settings-make-money')"><?php echo htmlspecialchars(__('Make Money', 'empowercast')); ?></button>
        <?php
        ...
        ?>
        <button id="live-item-tab" class="tablinks" onclick="empowercast_openTab(event, 'settings-live-item')"><?php echo htmlspecialchars(__('Live Item', 'empowercast')); ?></button>
        <?php } ?>
        <button id="experimental-tab" class="tablinks" onclick="empowercast_openTab(event, 'settings-experimental')"><?php echo htmlspecialchars(__('Experimental', 'empowercast')); ?></button>
    </div>
	
	<div id="settings-welcome" class="pp-tabcontent active">
        <div class="pp-sidenav-toggle-container">
            <div id="welcome-toggle-sidenav" class="toggle-sidenav" title="Podops Services" onclick="empowercast_displaySideNav(this);">&lt;</div>
            <div class="pp-sidenav">
                <?php
                empowercastadmin_edit_podops_services($General);
                ?>
                <div class="pp-sidenav-extra" style="margin-top: 10%;"><a href="https://www.podopshost.com/support/" class="pp-sidenav-extra-text"><?php echo htmlspecialchars(__('EMPOWERCAST DOCUMENTATION', 'empowercast')); ?></a></div>
        ...
        <button style="display: none;" id="welcome-default-open" class="pp-sidenav-tablinks active" onclick="sideNav(event, 'welcome-all')"><img class="pp-nav-icon" style="width: 22px;" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/rss-symbol.svg"><?php echo htmlspecialchars(__('Hidden button', 'empowercast')); ?></button>
        <div id="welcome-all" class="pp-sidenav-tab active">
	        <?php empowercastadmin_welcome($General, $FeedSettings); ?>
        </div>
	</div>

    <div id="settings-feeds" class="pp-tabcontent has-sidenav">
        <div class="pp-sidenav-toggle-container">
            <div id="feeds-toggle-sidenav" class="toggle-sidenav" title="More Feed Settings and Podops Services" onclick="empowercast_displaySideNav(this);">&lt;</div>
            <div class="pp-sidenav">
                <div class="pp-sidenav-extra"><p class="pp-sidenav-extra-text"><b><?php echo htmlspecialchars(__('FEED SETTINGS', 'empowercast')); ?></b></p></div>
                <button id="feeds-default-open" class="pp-sidenav-tablinks active" onclick="sideNav(event, 'feeds-feeds')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/megaphone_gray.svg"><?php echo htmlspecialchars(__('Podcast Feeds', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="feeds-settings-tab" onclick="sideNav(event, 'feeds-settings')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/option_bar_settings_gray.svg"><?php echo htmlspecialchars(__('Feed Settings', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="feeds-artwork-tab" onclick="sideNav(event, 'feeds-artwork')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/camera_gray.svg"><?php echo htmlspecialchars(__('Podcast Artwork', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="feeds-seo-tab" onclick="sideNav(event, 'feeds-seo')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/fileboard_checklist_gray.svg"><?php echo htmlspecialchars(__('Podcast SEO', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="feeds-basic-tab" onclick="sideNav(event, 'feeds-basic')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/edit_gray.svg"><?php echo htmlspecialchars(__('Basic Show Information', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="feeds-rating-tab" onclick="sideNav(event, 'feeds-rating')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/star_favorite_gray.svg"><?php echo htmlspecialchars(__('Rating Settings', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="feeds-apple-tab" onclick="sideNav(event, 'feeds-apple')"><span id="apple-icon-feed" class="destinations-side-icon" style="margin-left: 2px;"></span><span class="destination-side-text" style="margin-left: 6px;"><?php echo htmlspecialchars(__('Apple Settings', 'empowercast')); ?></span></button>
                <?php
                empowercastadmin_edit_podops_services($General);
                ?>
        ...
        <div id="feeds-feeds" class="pp-sidenav-tab active">
            <?php
            empowercastadmin_edit_feed_general($FeedSettings, $General, $FeedAttribs);
            empowercast_settings_tab_footer();
            ?>
        </div>
        <div id="feeds-settings" class="pp-sidenav-tab">
            <?php
            empowercastadmin_edit_feed_settings($FeedSettings, $General, $FeedAttribs);
            empowercast_settings_tab_footer();
            ?>
        </div>
        ...
        <div id="feeds-seo" class="pp-sidenav-tab">
            <?php
            require_once(EMPOWERCAST_ABSPATH . "/empowercastadmin-search.php");
            empowercast_admin_search();
            empowercast_settings_tab_footer();
            ?>
        </div>
        <div id="feeds-basic" class="pp-sidenav-tab">
            <?php
            empowercastadmin_edit_funding($FeedSettings);
            empowercast_settings_tab_footer();
            ?>
        </div>
        <div id="feeds-rating" class="pp-sidenav-tab">
            <?php
            empowercastadmin_edit_tv($FeedSettings);
            empowercast_settings_tab_footer();
            ?>
        </div>
    ...
    <div id="settings-website" class="pp-tabcontent">
        <div class="pp-sidenav-toggle-container">
            <div id="website-toggle-sidenav" class="toggle-sidenav" title="More Website Settings and Podops Services" onclick="empowercast_displaySideNav(this);">&lt;</div>
            <div class="pp-sidenav">
                <div class="pp-sidenav-extra"><p class="pp-sidenav-extra-text"><b><?php echo htmlspecialchars(__('WEBSITE SETTINGS', 'empowercast')); ?></b></p></div>
                <button id="website-default-open" class="pp-sidenav-tablinks active" onclick="sideNav(event, 'website-settings')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/desktop_gray.svg"><?php echo htmlspecialchars(__('Website Settings', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="website-blog-tab" onclick="sideNav(event, 'website-blog')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/file_gray.svg"><?php echo htmlspecialchars(__('Blog Posts and Pages', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="website-subscribe-tab" onclick="sideNav(event, 'website-subscribe')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/profile_plus_round_gray.svg"><?php echo htmlspecialchars(__('Subscribe Page', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="website-shortcodes-tab" onclick="sideNav(event, 'website-shortcodes')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/connection_pattern_gray.svg"><?php echo htmlspecialchars(__('EmpowerCast Shortcodes', 'empowercast')); ?></button>
                <button class="pp-sidenav-tablinks" id="website-new-window-tab" onclick="sideNav(event, 'website-new-window')"><img class="pp-nav-icon" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/play_gray.svg"><?php echo htmlspecialchars(__('Play in New Window', 'empowercast')); ?></button>
                <?php
                empowercastadmin_edit_podops_services($General);
                ?>
                <div class="pp-sidenav-extra"><a href="https://www.podopshost.com/support/" class="pp-sidenav-extra-text"><?php echo htmlspecialchars(__('EMPOWERCAST DOCUMENTATION', 'empowercast')); ?></a></div>
        ...
        if( $General === false )
            $General = empowercast_get_settings('empowercast_general');
        $General = empowercast_default_settings($General, 'appearance');
        ...
        <div id="website-settings" class="pp-sidenav-tab active">
            <?php
            empowercastadmin_website_settings($General, $FeedSettings);
            empowercast_settings_tab_footer();
            ?>
        </div>
        <div id="website-blog" class="pp-sidenav-tab">
            <?php
            empowercastadmin_blog_settings($General, $FeedSettings);
            empowercast_settings_tab_footer();
            ?>
        </div>
        <div id="website-subscribe" class="pp-sidenav-tab">
            <?php
            empowercast_subscribe_settings($General, $FeedSettings);
            empowercast_settings_tab_footer();
            ?>
        </div>
        <div id="website-shortcodes" class="pp-sidenav-tab">
            <?php
            empowercast_shortcode_settings($General, $FeedAttribs);
            empowercast_settings_tab_footer();
            ?>
        </div>
        <div id="website-new-window" class="pp-sidenav-tab">
            <?php
            empowercastadmin_new_window_settings($General, $FeedSettings);
            empowercast_settings_tab_footer();
            ?>
        </div>
    </div>
    ...
    <div id="settings-destinations" class="pp-tabcontent">
        <?php
        empowercastadmin_edit_destinations($FeedSettings, $General, $FeedAttribs);
        ?>
    </div>
	...
	{
		//empowercastadmin_edit_media_statistics($General);
	}
		?>
	</div>
	...
	<div id="settings-advanced" class="pp-tabcontent">
        <div class="pp-sidenav-toggle-container">
            <div id="advanced-toggle-sidenav" class="toggle-sidenav" title="Podops Services" onclick="empowercast_displaySideNav(this);">&lt;</div>
            <div class="pp-sidenav">
                <?php
                empowercastadmin_edit_podops_services($General);
                ?>
	...
	<?php
    empowercastadmin_advanced_options($General, false);
    ?>
    </div>
    ...
    <div id="settings-make-money" class="pp-tabcontent">
        ...
        <button style="display: none;" id="make-money-default-open" class="pp-sidenav-tablinks active" onclick="sideNav(event, 'make-money-all')"><img class="pp-nav-icon" style="width: 22px;" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/rss-symbol.svg"><?php echo htmlspecialchars(__('Hidden button', 'empowercast')); ?></button>

        <div id="make-money-all" class="pp-sidenav-tab active">
            <div class="pp_container">
                <h1 class="pp-heading"><?php echo __('Programmatic Advertising', 'empowercast'); ?></h1>
                <br />
                <p class="pp-sub"><?php echo __('Podops hosting customers have access to our Programmatic Advertising service, which automatically puts ads into your show and pays YOU out directly from Podops! Simply configure your shows in the Podops Publisher then use the link there to sync you WordPress site.', 'empowercast'); ?></p>
                <br />
                <p class="pp-main"><a class="pp-main" target="_blank"
                   href="https://podopshost.com/services/programmatic-advertising/"
                   class="pp_align-center"><?php echo __('Learn More', 'empowercast'); ?></a></p>
                <br />
                <p class="pp-main"><a class="pp-main"
                   href="<?php echo $publisher_origin; ?>/partners/programmatic-advertising-management/"
                   class="pp_align-center"><?php echo __('Configure Shows for Programmatic Ads', 'empowercast'); ?></a></p>
    ...
    <div id="settings-live-item" class="pp-tabcontent">
        ...
        <?php empowercastadmin_live_item_options($FeedSettings); ?>
    </div>
    ...
    <div id="settings-experimental" class="pp-tabcontent">
        ...
        <?php
        empowercastadmin_experimental_options($FeedSettings);
        ?>
    </div>
...
function empowercastadmin_live_item_options($Feed)
{
    ...
    <div style="margin-left: 10px;">
        <button style="display: none;" id="live-item-default-open" class="pp-sidenav-tablinks active" onclick="sideNav(event, 'live-item-all')"><img class="pp-nav-icon" style="width: 22px;" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/rss-symbol.svg"><?php echo htmlspecialchars(__('Hidden button', 'empowercast')); ?></button>
        <div id="live-item-all" class="pp-sidenav-tab active">
            <h1 class="pp-heading"><?php echo __('Live Item Tag', 'empowercast'); ?></h1>
            <?php if ($litError) {
                ?>
                <div class="alert alert-danger" role="alert">
                    <span><?php echo __($litErrorMsg, 'empowercast'); ?></span>
                </div>
            <?php } ?>
            <p><?php echo __('This is a new initiative as part of Podcasting 2.0. The Live Item tag is for those with a live component to your show, whether it be an audio stream or a video stream. It is important to know that only apps that designate the LIT function at NewPodcastApps.com support this.', 'empowercast'); ?></p>
            <p><?php echo __('Going live is a bigger part of podcasting now. What has been developed by Podcasting 2.0 is the ability for you to show up as live in the supported apps. Giving those listeners the ability to be notified in supported podcasting apps that you are live to be able to listen or watch within the podcasting apps that support this.', 'empowercast'); ?></p>
            <div class="col">
                <div class="row">
                    ...
                    <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em; display: flex; align-items: center; justify-content: flex-start;"">
                        <p class="pp-main">
                            ...
                            <div class="pp-tooltip-right" style="height: 16px; width: 16px; margin-left: 5px;">i
                                <span class="text-pp-tooltip" style="top: -50%; min-width: 200px;"><?php echo esc_html(__('By enabling this, you will notify apps of the status of your event, be it Pending, Live, or Ended.', 'empowercast')); ?></span>
                            </div>
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-2 pl-0">
                            ...
                            <div class="pp-tooltip-right" style="height: 16px; width: 16px; margin-left: 5px;">i
                                <span class="text-pp-tooltip" style="top: -50%; min-width: 200px;">
                                    <?php echo esc_html(__("You must set your statuses for each part of the process.
                                            ...
                                            You have to make these status changes to inform platforms of the current Live status.", "empowercast")); ?>
                                    <br />
                                    <br />
                                    <?php echo __("Pending: Announce the parameters of when you expect to go live. This can be set hours or days before the event.", "empowercast")?>
                                    <br/>
                                    <br />
                                    <?php echo __("Live: When you are moments away from going live, update your setting to Live. This will let the supported apps know that you are truly going live. Please note that deviations on when you are expected to go live and when you actually do can change. This will inform the apps you are indeed live.", "empowercast")?>
                                    <br />
                                    <br />
                                    <?php echo __("Ended: Inform apps that your Live show has ended.", "empowercast")?>
                                </span>
                            </div>
                        </label>
                        ...
                        <select name="Feed[live_item][status]" id="lit-status" class="pp-settings-select" style="width: 100% !important; font-size: 95%;">
                            <option <?php echo (!empty($lit['status']) && $lit['status']  == 'Pending') || empty($lit['status']) ? 'selected' : '' ?> value="Pending"><?php echo __("Pending", "empowercast"); ?></option>
                            <option <?php echo !empty($lit['status']) && $lit['status'] == 'Live' ? 'selected' : '' ?> value="Live"><?php echo __("Live", "empowercast"); ?></option>
                            <option <?php echo !empty($lit['status']) && $lit['status'] == 'Ended' ? 'selected' : '' ?> value="Ended"><?php echo __("Ended", "empowercast"); ?></option>
                        </select>
                    </div>
                    ...
                    <div class="col-lg-8 pl-0">
                        ...
                        <label for="lit-guid" style="margin: 0; display: flex; align-items: center; justify-content: flex-start;">
                            <h3><?php echo __("Live Item Guid", "empowercast"); ?></h3>
                            <div class="pp-tooltip-right" style="height: 16px; width: 16px; margin-left: 5px;">i
                                <span class="text-pp-tooltip" style="top: -50%; min-width: 200px;"><?php echo esc_html(__('Like every Podcast, Podcasting 2.0 assigns a GUID for your live events. This is informational only and highly technical but this GUID will stay with your live events for the life of your show.', 'empowercast')); ?></span>
                            </div>
                        </label>
                        <p><?php echo !empty($lit['guid']) ? $lit['guid'] : __("Your GUID will be created once you give your live item a title.", "empowercast"); ?></p>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-4 pl-0">
                        <label for="lit-start-date" style="margin: 0;"><h3><?php echo __("Start Date/Time", "empowercast"); ?><span style="color: red;">*</span></h3></label>
                    ...
                    <div class="col-lg-4 pl-0">
                        <label for="lit-end-date" style="margin: 0;"><h3><?php echo __("End Date/Time", "empowercast"); ?><span style="color: red;">*</span></h3></label>
                    ...
                    <div class="col-lg-4 pl-0">
                        <label for="lit-timezone" style="margin: 0; display: flex; align-items: center; justify-content: flex-start;">
                            <h3><?php echo __("Timezone", "empowercast"); ?><span style="color: red;">*</span></h3>
                            <div class="pp-tooltip-right" style="height: 16px; width: 16px; margin-left: 5px;">i
                                <span class="text-pp-tooltip" style="top: -50%; min-width: 200px;"><?php echo esc_html(__('Note: (EST, CST, MST, and PST) are from March 12th to Nov 15th, with (EDT, CDT, MDT, and PDT) from Nov 16th to March 11th)', 'empowercast')); ?></span>
                            </div>
                        </label>
                ...
                <div class="row">
                    <div class="col-lg-12 pl-0">
                        <label for="lit-title" style="margin: 0;"><h3><?php echo __("Livestream Title", "empowercast"); ?><span style="color: red;">*</span></h3></label>
                ...
                <div class="row">
                    <div class="col-lg-2 pl-0 pr-0">
                        <label for="lit-stream-type" style="margin: 0;"><h3><?php echo __("Stream Type", "empowercast"); ?><span style="color: red;">*</span></h3></label>
                    ...
                    <div class="col-lg-5 pl-0">
                        <label for="lit-fallback-link" style="margin: 0; display: flex; align-items: center; justify-content: flex-start;">
                            <h3><?php echo __("Fallback Link", "empowercast"); ?><span style="color: red;">*</span></h3>
                            <div class="pp-tooltip-right" style="height: 16px; width: 16px; margin-left: 5px;">i
                                <span class="text-pp-tooltip" style="top: -50%; min-width: 200px;"><?php echo esc_html(__("If the podcast app does not support your livestream protocol, you need to link to your live YouTube episode or a dedicated page on your website with the live audio or video stream contained there.", 'empowercast')); ?></span>
                            </div>
                        </label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 pl-0">
                        <label for="lit-cover-art" style="margin: 0; display: flex; align-items: center; justify-content: flex-start;">
                            <h3><?php echo __("Cover Art (Optional)", "empowercast"); ?></h3>
                            <div class="pp-tooltip-right" style="height: 16px; width: 16px; margin-left: 5px;">i
                                <span class="text-pp-tooltip" style="top: -50%; min-width: 200px;"><?php echo esc_html(__("This is album art that will only be shown when you are live so if you want to have specific art shown while you live, you can provide a link to it. Minimum 1400x1400, similar to Apple podcast art but solely used for your live events.", 'empowercast')); ?></span>
                            </div>
                        </label>
                ...
                <div class="row">
                    <div class="col-lg-12 pl-0">
                        <label for="lit-description" style="margin: 0;"><h3><?php echo __("Description (Optional)", "empowercast"); ?></h3></label>
            ...
            <?php empowercast_settings_tab_footer(); ?>
        </div>
    </div>
...
function empowercastadmin_advanced_options($General, $link_account = false)
{
	// Break the bottom section here out into it's own function
	$ChannelsCheckbox = '';
	if( !empty($General['custom_feeds']) )
		$ChannelsCheckbox = ' onclick="alert(\''.  __('You must delete all of the Podcast Channels to disable this option.', 'empowercast')  .'\');return false;"';
	$CategoryCheckbox = '';
...
<div style="margin-left: 10px;">
    ...
    <button style="display: none;" id="advanced-default-open" class="pp-sidenav-tablinks active" onclick="sideNav(event, 'advanced-all')"><img class="pp-nav-icon" style="width: 22px;" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/rss-symbol.svg"><?php echo htmlspecialchars(__('Hidden button', 'empowercast')); ?></button>
	<div id="advanced-all" class="pp-sidenav-tab active">
        <h1 class="pp-heading"><?php echo __('Advanced Settings', 'empowercast'); ?></h1>
        ...
        <div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Multi-Program Mode', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('This feature allows you to publish to multiple Podops-hosted shows from a single user account.', 'empowercast'); ?></p>
            </div>
		</div>
        <div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('User Role Management', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Adding User Role Management will allow administrators, editors and authors access to create and configure podcast episodes. 
                    This feature is supported by WordPress Roles and Capabilities.', 'empowercast'); ?>
                </p>
            </div>
        </div>
		<div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><a href="<?php echo admin_url('admin.php?page=empowercast/empowercastadmin_import_feed.php'); ?>"><?php echo __('Import Podcast', 'empowercast'); ?></a></p>
                <p class="pp-sub"><?php echo __('Import podcast feed from SoundCloud, LibSyn, PodBean or other podcast service.', 'empowercast'); ?></p>
            </div>
		</div>
		<div>
			<input class="pp-settings-checkbox" style="margin-top: 3em;" type="checkbox" name="NULL[migrate_media]" value="1" checked disabled />
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><a href="<?php echo admin_url('admin.php?page=empowercast/empowercastadmin_migrate.php'); ?>"><?php echo __('Migrate Media', 'empowercast'); ?></a></p>
                <p class="pp-sub"><?php echo __('Migrate media files to Podops Podcast Media Hosting with only a few clicks.', 'empowercast'); ?></p>
            </div>
		</div>
		<div>
			<input class="pp-settings-checkbox" style="margin-top: 3em;" type="checkbox" name="NULL[podcasting_seo]" value="1" checked disabled />
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><a id="advanced-tab-seo-link" onclick="goToPodcastSEO();return false;"><?php echo __('Podcasting SEO', 'empowercast'); ?></a></p>
                <p class="pp-sub"><?php echo __('Optimize how your podcast appears in Internet search results.', 'empowercast'); ?></p>
            </div>
		</div>
		...
		<div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Audio Player Options', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Select from 3 different web based audio players.', 'empowercast'); ?>
                    <b><a href="<?php echo admin_url('admin.php?page=empowercast/empowercastadmin_player.php&sp=1'); ?>">(<?php echo __('configure audio player', 'empowercast'); ?>)</a></b></p>
            </div>
		</div>
		<div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Video Player Options', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Select from 3 different web based video players.', 'empowercast'); ?>
                <b><a href="<?php echo admin_url('admin.php?page=empowercast/empowercastadmin_videoplayer.php&sp=1'); ?>">(<?php echo __('configure video player', 'empowercast'); ?>)</a></b></p>
            </div>
		</div>
		<div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Custom Podcast Channels', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Manage multiple media files and/or formats to one blog post.', 'empowercast'); ?>
                <?php if( empty($General['channels']) ) { ?>
                (<?php echo __('feature will appear in left menu when enabled', 'empowercast'); ?>)
                <?php } else { ?>
                <b><a href="<?php echo admin_url('admin.php?page=empowercast/empowercastadmin_customfeeds.php'); ?>">(<?php echo __('configure podcast channels', 'empowercast'); ?>)</a></b>
                <?php } ?>
                </p>
            </div>
		</div>
		<div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Category Podcasting', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Manage podcasting for specific categories.', 'empowercast'); ?>
                <?php if( empty($General['cat_casting']) ) { ?>
                (<?php echo __('feature will appear in left menu when enabled', 'empowercast'); ?>)
                <?php } else { ?>
                <b><a href="<?php echo admin_url('admin.php?page=empowercast/empowercastadmin_categoryfeeds.php'); ?>">(<?php echo __('configure podcast categories', 'empowercast'); ?>)</a></b>
                <?php } ?>
                </p>
            </div>
		</div>
		...
		<div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Taxonomy Podcasting', 'empowercast'); ?>
                <p class="pp-sub"><?php echo __('Manage podcasting for specific taxonomies.', 'empowercast'); ?>
                <?php if( empty($General['taxonomy_podcasting']) ) { ?>
                (<?php echo __('feature will appear in left menu when enabled', 'empowercast'); ?>)
                <?php } else { ?>
                <b><a href="<?php echo admin_url('admin.php?page=empowercast/empowercastadmin_taxonomyfeeds.php'); ?>">(<?php echo __('configure taxonomy podcasting', 'empowercast'); ?>)</a></b>
                <?php } ?>
                </p>
            </div>
		</div>
		<div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Post Type Podcasting', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Manage multiple media files and/or formats to specific post types.', 'empowercast'); ?>
                <?php if( empty($General['posttype_podcasting']) ) { ?>
                (<?php echo __('feature will appear in left menu when enabled', 'empowercast'); ?>)
                <?php } else { ?>
                <b><a href="<?php echo admin_url('admin.php?page=empowercast/empowercastadmin_posttypefeeds.php'); ?>">(<?php echo __('configure post type podcasting', 'empowercast'); ?>)</a></b>
                <?php } ?>
                </p>
            </div>
		</div>
		<div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('EmpowerCast Playlist Player', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Create playlists for your podcasts.', 'empowercast'); ?>
                <b><a href="https://podopshost.com/support/empowercast-documentation/empowercast-playlist-shortcode/" target="_blank">(<?php echo __('learn more', 'empowercast'); ?>)</a></b>
                </p>
            </div>
		</div>
        <div>
            <input class="pp-settings-checkbox" style="margin-top: 3em;" type="checkbox" name="General[empowercast_network]" value="1" <?php echo ( !empty($General['empowercast_network']) ?' checked':''); ?> />
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('EmpowerCast Network', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Create a network of podcasts.', 'empowercast'); ?>
                    <b><a href="https://podopshost.com/support/empowercast-documentation/podcast-network/" target="_blank">(<?php echo __('learn more', 'empowercast'); ?>)</a></b>
                </p>
            </div>
        </div>
        <div>
            <input class="pp-settings-checkbox" style="margin-top: 3em;" type="checkbox" name="General[empowercast_accept_json]" value="1" <?php echo ( !empty($General['empowercast_accept_json']) ?' checked':''); ?> />
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Allow JSON uploads', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Check this box if you plan to upload chapter files to your WordPress site.', 'empowercast'); ?>
                </p>
            </div>
        </div>
        <div>
            ...
            <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 2em;">
                <p class="pp-main"><?php echo __('Show errors in Block Editor', 'empowercast'); ?></p>
                <p class="pp-sub"><?php echo __('Disable if you are not planning to use the EmpowerCast Block.', 'empowercast'); ?>
                </p>
            </div>
        </div>
        <?php
...
function empowercastadmin_experimental_options($General, $link_account = false)
{
        ...
        jQuery(document).ready(function() {
            ...
            jQuery("[name='newperson']").click(function (e) {
                ...
                let newHTML = '<div class="col mt-4 pl-0 pr-0" id="person-select-' + tempCount + '">' +
                    ...
                    '<label style="font-size: 110%; font-weight: bold;" for="value-select"><?php echo __('Wallet Service', 'empowercast'); ?></label>' +
                    '</div>' +
                    '<div class="col-lg-8 pl-0">' +
                    '<label style="font-size: 110%; font-weight: bold;" for="person-' + tempCount + '-select-lightning"><?php echo __('Lightning Address', 'empowercast'); ?></label>' +
                    '</div>' +
            ...
            jQuery("#recipient-container").on("click", "#next-btn", function (e) {
                ...
                if (!error) {
                    ...
                    let newHTML = '<div class="row mt-4" id="person-' + currentPersonCount + '-container" style="display: flex; align-items: center;">' +
                        ...
                        '<div class="row pl-0">' +
                        '<div class="col-lg-4 pl-0">' +
                        '<label style="font-size: 110%; font-weight: bold;" for="person-' + currentPersonCount + '-lightning"><?php echo __('Lightning Address / Name', 'empowercast'); ?></label>' +
                        '<br />' +
                        '<br />' +
                        ...
                        '</div>' +
                        '<div class="col-lg-4 pl-0">' +
                        '<label style="font-size: 110%; font-weight: bold;" for="person-' + currentPersonCount + '-customkey"><?php echo __('Custom Key', 'empowercast'); ?></label>' +
                        '<br />' +
                        '<br />' +
                        ...
                        '</div>' +
                        '<div class="col-lg-4 pl-0">' +
                        '<label style="font-size: 110%; font-weight: bold;" for="person-' + currentPersonCount + '-customvalue"><?php echo __('Custom Value', 'empowercast'); ?></label>' +
                        '<br />' +
                        '<br />' +
                        ...
                        '<div class="col-lg-8 pl-0">' +
                        '<label style="font-size: 110%; font-weight: bold;" for="person-' + currentPersonCount + '-pubkey"><?php echo __('PubKey', 'empowercast'); ?></label>' +
                        '<br />' +
                        '<br />' +
                        ...
                        '</div>' +
                        '<div class="col-lg-4 pl-0">' +
                        '<label style="font-size: 110%; font-weight: bold;" for="person-' + currentPersonCount + '-split"><?php echo __('Split', 'empowercast'); ?></label>' +
                        '<br />' +
                        '<br />' +
                    ...
                    currentPersonCount -= 1;
                    let newHTML = '<div class="alert alert-danger" role="alert"><span><?php echo __("We were unable to locate wallet information for lightning address: ", 'empowercast'); ?>'+defaultLightning+'. <?php echo __("Please double check your entry and try again.", 'empowercast'); ?></span></div>';
    ...
    <div style="margin-left: 10px;">
        <button style="display: none;" id="experimental-default-open" class="pp-sidenav-tablinks active" onclick="sideNav(event, 'experimental-all')"><img class="pp-nav-icon" style="width: 22px;" alt="" src="<?php echo empowercast_get_root_url(); ?>images/settings_nav_icons/rss-symbol.svg"><?php echo htmlspecialchars(__('Hidden button', 'empowercast')); ?></button>
        <div id="experimental-all" class="pp-sidenav-tab active">
            <div style="display: flex; flex-direction: row; justify-content: flex-start; align-items: center;">
                <h1 class="pp-heading"><?php echo __('Value4Value (V4V)', 'empowercast'); ?></h1>
                <a href="https://podopshost.com/support/podcasting-2-0-introduction/" style="color: inherit; text-decoration: none;" target="_blank"><div class="pp-tooltip-right" style="height: 20px; width: 20px; margin: 1ch 0 0 1ch;">i</div></a>
            </div>
            <?php
            if ($valueError) {
            ?>
                <div class="alert alert-danger" role="alert">
                    <span><?php echo __($valueErrorMsg, 'empowercast'); ?></span>
                </div>
            <?php } ?>
            <div class="row mr-0 ml-0">
                <p class="pp-sub">
                    ...
                    Podops has partnered with Alby to participate in the Value 4 Value podcast model.
                    Signing up with ', 'empowercast');
                    echo '<a href="http://getalby.com/">'.__('Alby', 'empowercast').'</a> ';
                    echo __('(free) will get you a user@getalby.com address you can enter in the configuration below.', 'empowercast');
                    ?>
                </p>
            </div>
            <div class="row mr-0 ml-0 mt-4">
                <p class="pp-sub">
                    <?php
                    echo __('Alby and Fountain users only need to enter their Alby or Fountain address and click the arrow, and we will pre-populate the appropriate fields.', 'empowercast');
                    ?>
                </p>
            </div>
            <div class="row mr-0 ml-0 mt-4">
            ...
            <div class="row mr-0 ml-0 mt-4">
                <p class="pp-sub">
                    <strong><?php echo __('Warning:', 'empowercast'); ?></strong>
                    <?php echo __('For those entering the data manually, you should check with your vendor on the valid entries for each field.', 'empowercast'); ?>
                </p>
            </div>
            ...
            <?php }
                ...
                <div class="row pr-4" style="margin-top: 20px;" id="add-person-container">
                    <div class="col-lg-12" style="display: flex; justify-content: flex-end;">
                        <button class="value-btn" type="button" style="border: none; background: inherit; color: #1976D2;" id="newperson" name="newperson"><?php echo __('+ Add Person', 'empowercast'); ?></button>
                    </div>
                </div>
            </div>
            <hr />
...
function empowercastadmin_edit_podpress_options($General)
{
	if( !empty($General['process_podpress']) || empowercast_podpress_episodes_exist() )
	{
...
<h3><?php echo __('PodPress Options', 'empowercast'); ?></h3>
<table class="form-table">
<tr valign="top">
<th scope="row">

<?php echo __('PodPress Episodes', 'empowercast'); ?></th> 
<td>
<select name="General[process_podpress]" class="bpp_input_med">
<?php
$options = array(0=>__('Ignore', 'empowercast'), 1=>__('Include in Posts and Feeds', 'empowercast') );

foreach( $options as $value => $desc )
	echo "\t<option value=\"$value\"". ($General['process_podpress']==$value?' selected':''). ">$desc</option>\n";
	
?>
</select>  (<?php echo __('includes podcast episodes previously created in PodPress', 'empowercast'); ?>)
</td>
</tr>
	<?php if( !empty($General['podpress_stats']) || empowercast_podpress_stats_exist() ) { ?>
	<tr valign="top">
	<th scope="row">

	<?php echo __('PodPress Stats Archive', 'empowercast'); ?></th> 
	<td>
	<select name="General[podpress_stats]" class="bpp_input_sm">
	<?php
	$options = array(0=>__('Hide', 'empowercast'), 1=>__('Display', 'empowercast') );

	foreach( $options as $value => $desc )
		echo "\t<option value=\"$value\"". ($General['podpress_stats']==$value?' selected':''). ">$desc</option>\n";
		
	?>
	</select>  (<?php echo __('display archive of old PodPress statistics', 'empowercast'); ?>)
	</td>
	</tr>
	<?php } ?>
	</table>
...
function empowercastadmin_edit_itunes_general($FeedSettings, $General, $FeedAttribs = array() )
{
...
?>
<h3><?php echo __('iTunes Listing Information', 'empowercast'); ?></h3>

<?php
} // end itunes general

function empowercastadmin_edit_podops_services($General, $action_url = false, $action = false)
{
...
?>
<div id="connect-podops-services">
    <?php
    $creds = get_option('empowercast_creds');
    if( $creds ) { ?>
        <div id="podops-services-connected-settings">
            <div style="margin-bottom: 1em;">
                <span><img src="<?php echo empowercast_get_root_url(); ?>images/done_24px.svg" style="margin: 0 0 0 8%;vertical-align: text-bottom;"  alt="<?php echo __('Enabled!', 'empowercast'); ?>" /></span>
                <p id="connected-podops-blurb"><?php echo __("Connected to <b>Podops</b>", 'empowercast'); ?></p>
            </div>
            <a style="display: block;" class="thickbox" title="<?php echo esc_attr(__('Podops Services Integration', 'empowercast')); ?>" href="<?php echo admin_url(); echo wp_nonce_url( "admin.php?action=empowercast-jquery-account-edit", 'empowercast-jquery-account-edit'); ?>&amp;KeepThis=true&amp;TB_iframe=true&amp;width=600&amp;height=400&amp;modal=true" target="_blank"><?php echo __('Podops Hosting Settings', 'empowercast'); ?></a>
        </div>
    <?php
    }
...
?>
        <div id="connect-see-options">
            <img id="podops-logo-connect" alt="" src="<?php echo empowercast_get_root_url(); ?>images/podops_icon.png">
            <h4><?php echo sprintf(__('<b>EmpowerCast</b> works best with <b>Podops</b>', 'empowercast')); ?></h4>
            <p id="connect-podops-blurb"><?php echo sprintf(__('Get access to detailed analytics and more by <b>connecting to your Podops Hosting Account.</b>', 'empowercast')); ?></p>
            <p style="font-size: 125%; margin: 1ch 0 0 1ch">
                <strong><a class="button-primary  button-podops" id="connect-podops-button-options"
                           title="<?php echo esc_attr(__('Podops Services Info', 'empowercast')); ?>"
                           href="https://podopshost.com/services/podcast-hosting/"
                           target="_blank"><?php echo __('SEE MY OPTIONS', 'empowercast'); ?></a></strong>
            </p>
        </div>
        <div id="connect-podops-button-container">
            <p style="margin-top: 1ch;" class="pp-settings-text-no-margin"><?php echo __('Already have a Podops account?', 'empowercast'); ?></p>
            <p style="font-size: 125%; margin-top: 5px;">
                <strong><button class="button-primary  button-podops" id="connect-podops-button-options"
                           type="submit" name="podops-login" value="1"
                           title="<?php echo esc_attr(__('Podops Services Integration', 'empowercast')); ?>">
                        <?php echo __('LET\'S CONNECT', 'empowercast'); ?></button></strong>
...
<?php
    if (time() < strtotime('August 1 2023')) {
        $pp_notif = new EmpowerCast_Notification_Manager();
        $pp_notif->print_one_notice('more-test', true);
    }
}

function empowercastadmin_edit_media_statistics($General)
{
    ...
    $StatsIntegrationURL = '';
	if( !empty($General['podops_program_keyword']) )
		$StatsIntegrationURL = 'https://media.podopshost.com/'.$General['podops_program_keyword'].'/';
?>
    <script>
        function showSecondRedirectInput(event) {
            event.preventDefault();
            document.getElementById('empowercast_redirect2_table').style.display = 'block';
            document.getElementById('empowercast_redirect2_showlink').style.display='none';

        }
        function showThirdRedirectInput(event) {
            event.preventDefault();
            document.getElementById('empowercast_redirect3_table').style.display='block';
            document.getElementById('empowercast_redirect3_showlink').style.display='none';
        }
    </script>
<div id="podops_stats_settings">
<h2><?php echo __('Media Statistics', 'empowercast'); ?></h2>
    <div>
        ...
        <div class="pp-settings-subsection" style="border-bottom: none; margin-top: 0;">
            <p class="pp-main"><?php echo __('Remove Statistics from WordPress Dashboard', 'empowercast'); ?></p>
        </div>
    </div>
	<div>
        ...
        <div id="stats-prefix-notice" class="card alert alert-danger p-3">
            <h4 style="margin-bottom: 0.5em;">
                <img src="<?php echo empowercast_get_root_url(); ?>images/circleerror_black.svg" alt="Notice" style="width: 24px; vertical-align: text-bottom;" />
                <p>Notice</p>
            </h4>
            ...
            <ul>
                <li>Not all redirect/prepend prefix services are engineered the same. Once you add a prefix/prepend be aware you are reliant on those companies’ service to “always” be online. A failure on their platform will result in your show’s media not being delivered.
                    <ul>
                        <li style="font-size: 100%;">Service Reliability and LSA: All 3rd party redirect services void the Podops Service-Level Agreement (SLA). Please be sure the redirect service you are using has a comparable SLA and uptime guarantee.</li>
                    </ul>
                </li>
		...
		<div style="position: relative; padding-bottom: 10px;">
			...
			<tr valign="top">
			<th scope="row">
			<?php echo __('Stats Prefix 1', 'empowercast'); ?>
			</th>
			<td>
			...
			<div style="position: absolute;bottom: -2px;left: -40px;" id="empowercast_redirect2_showlink">
				<a href="#" style="margin-left: 40px;" onclick="showSecondRedirectInput(event)"><?php echo __('Add Another Prefix', 'empowercast'); ?></a href="#">
			</div>
			<?php } ?>
		</div>
	
		
		<div id="empowercast_redirect2_table" style="position: relative; <?php if( empty($General['redirect2']) && empty($General['redirect3']) ) echo 'display:none;'; ?> padding-bottom: 10px;">
			<table class="form-table">
			<tr valign="top">
			<th scope="row">
			<?php echo __('Stats Prefix 2', 'empowercast'); ?>
			</th>
			<td>
			...
			<div style="position: absolute;bottom: -2px;left: -40px;" id="empowercast_redirect3_showlink">
				<a href="#" style="margin-left: 40px;" onclick="showThirdRedirectInput(event)"><?php echo __('Add Another Prefix', 'empowercast'); ?></a>
			</div>
			<?php } ?>
		</div>

		<div id="empowercast_redirect3_table" style="<?php if( empty($General['redirect3']) ) echo 'display:none;'; ?>">
			<table class="form-table">
			<tr valign="top">
			<th scope="row">
			<?php echo __('Stats Prefix 3', 'empowercast'); ?>
			</th>
			<td>
...
</div><!-- end podops_stats_settings -->
<?php
}

	
function empowercastadmin_appearance($General=false, $Feed = false)
{
	if( $General === false )
		$General = empowercast_get_settings('empowercast_general');
	$General = empowercast_default_settings($General, 'appearance');
	...
	/*
	$Players = array('podcast'=>__('Default Podcast (podcast)', 'empowercast') );
	...
	*/
    require_once( dirname(__FILE__).'/views/settings_tab_appearance.php' );
    empowercastadmin_website_settings($General, $Feed);
    empowercastadmin_blog_settings($General, $Feed);
    empowercast_subscribe_settings($General, $Feed);
    empowercast_shortcode_settings($General, $Feed);
    empowercastadmin_new_window_settings($General, $Feed);
?>
...
// Admin page, footer
function empowercast_settings_tab_footer()
{ ?>
...
function empowercastadmin_welcome($GeneralSettings, $FeedSettings, $NewPostQueryString = '')
{
    ...
    if (isset($FeedSettings['itunes_image']) && !empty($FeedSettings['itunes_image'])) {
        ...
        $image = empowercast_get_root_url() . 'images/pts_cover.jpg';
    }
    ...
    $numEp = empowercast_admin_episodes_per_feed($feed_slug);
?>
    <script>
...
<div>
    <div class="pp-settings-setup-notifications">
        <?php
        $stats_notice_dismissed = get_option('empowercast_stats_notice_dismissed');
        $creds = get_option('empowercast_creds');
        if ( !$creds && !$stats_notice_dismissed) {
            $stats_dismiss_url = admin_url('admin.php?page=empowercastadmin_basic&action=empowercast_dismiss&notice=stats');
            ?>
            <div class="pp-welcome-notification">
                <a href='<?php echo $stats_dismiss_url; ?>'>x</a>
                <img src="<?php echo empowercast_get_root_url(); ?>images/onboarding/podops_stats.png" />
                <div class="pp-welcome-notification-text">
                    <h3><?php echo __('Free Podcast Statistics', 'empowercast'); ?></h3>
                    <p>
                        <?php echo __('View a summary of your Podops Statistics right here in Empowercast.', 'empowercast'); ?>
                        &nbsp;<a href="https://podopshost.com/support/empowercast-documentation/services-stats/"><?php echo __('Learn More', 'empowercast'); ?></a>
                    </p>
                </div>
            </div>
        ...
        $artwork_notice_dismissed = get_option('empowercast_artwork_notice_dismissed');
        if( empty($FeedSettings['itunes_image']) && !$artwork_notice_dismissed ) {
            $stats_dismiss_url = admin_url('admin.php?page=empowercastadmin_basic&action=empowercast_dismiss&notice=artwork');
            ?>
            <div class="pp-welcome-notification">
                <a href='<?php echo $stats_dismiss_url; ?>'>x</a>
                <img src="<?php echo empowercast_get_root_url(); ?>images/onboarding/hosting_icon.png" />
                <div class="pp-welcome-notification-text">
                    <h3><?php echo __('Your Show is (almost) ready for everyone', 'empowercast'); ?></h3>
                    <p><?php echo __('Some finishing touched needed to send your RSS feed to destinations.', 'empowercast'); ?></p>
                    <p>
                        <a href="<?php echo admin_url('admin.php?page=empowercastadmin_basic&tab=feeds-tab&sidenav-tab=feeds-artwork-tab'); ?>"><?php echo __('Add Show Artwork', 'empowercast'); ?></a>
                        <a style="margin-left: 1em;" href="<?php echo admin_url('post-new.php'); ?>"><?php echo __('Post your first episode', 'empowercast'); ?></a>
                    </p>
                </div>
            </div>
            <?php
        ...
        <div class="prog-sum-head">
            ...
            <div class="pp-settings-recent-post">
                ...
                <div class="pp-settings-welcome-text">
                    <p class="pp-settings-text-no-margin" style="margin-bottom: 2ch;"><?php echo __('By', 'empowercast'); ?> <?php echo isset($FeedSettings['itunes_talent_name']) ? $FeedSettings['itunes_talent_name'] : ''; ?></p>
                    <p class="pp-settings-text-no-margin"><?php echo htmlspecialchars($description); ?></p>
                </div>
            </div>
            <div class="pp-settings-num-episodes">
                <p class="pp-settings-text-no-margin"><?php echo __('Number of Episodes', 'empowercast'); ?></p>
        ...
        <div class="prog-sum-contents">
            <a id="welcome-tab-new-post" href="<?php echo admin_url('post-new.php') . $NewPostQueryString; ?>">
                <div class="pp_button-container">
                    <?php echo __('CREATE NEW EPISODE', 'empowercast'); ?>
                </div>
            </a>
            <div class="pp-settings-podcast-status">
                <p class="pp-settings-text-no-margin" style="margin-bottom: 2ch;"><?php echo __('Podcast Status', 'empowercast'); ?></p>
                ...
                <?php if (!$GeneralSettings || (isset($GeneralSettings['pp_onboarding_incomplete']) && $GeneralSettings['pp_onboarding_incomplete'] == 1) && (isset($GeneralSettings['timestamp']) && $GeneralSettings['timestamp'] > 1576972800)) { ?>
                    <p class="pp-settings-status-text"><a class="program-status-link" href="<?php echo admin_url("admin.php?page=empowercastadmin_onboarding.php"); ?>"><img src="<?php echo empowercast_get_root_url(); ?>images/status_incomplete.svg" class="pp-settings-icon-small"  alt="<?php echo __('Not done', 'empowercast'); ?>" />Finish Show Prep</a></p>
                <?php } else { ?>
                    <p class="pp-settings-status-text"><img src="<?php echo empowercast_get_root_url(); ?>images/status_complete.svg" class="pp-settings-icon-small"  alt="<?php echo __('Done!', 'empowercast'); ?>" />Finished Show Prep</p>
                <?php }

                if (empty($FeedSettings['itunes_image'])) { ?>
                    <p id="pp-welcome-artwork-link" class="program-status-link" onclick="goToArtworkSettings();return false;"><img src="<?php echo empowercast_get_root_url(); ?>images/status_incomplete.svg" class="pp-settings-icon-small"  alt="<?php echo __('Not done', 'empowercast'); ?>" />Add Artwork to Show</p>
                <?php } else { ?>
                    <p class="pp-settings-status-text"><img src="<?php echo empowercast_get_root_url(); ?>images/status_complete.svg" class="pp-settings-icon-small"  alt="<?php echo __('Done!', 'empowercast'); ?>" />Added Artwork to Show</p>
                <?php } ?>
                ...
                if(!empty($FeedSettings['itunes_url']) ||
                    ...
                    <p id="pp-welcome-applesubmit-link" class="program-dest-welcome-link" onclick="goToDestinationSettings();return false;"><img src="<?php echo empowercast_get_root_url(); ?>images/status_complete.svg" class="pp-settings-icon-small"  alt="<?php echo __('Done!', 'empowercast'); ?>" />Set Destination Links</p>
                <?php } else { ?>
                    <p id="pp-welcome-applesubmit-link" class="program-status-link" onclick="goToDestinationSettings();return false;"><img src="<?php echo empowercast_get_root_url(); ?>images/status_incomplete.svg" class="pp-settings-icon-small"  alt="<?php echo __('Not done', 'empowercast'); ?>" />Set Destination Links</p>
                <?php } ?>

            </div>
        </div>
    </div>
	<div class="empowercast-welcome-news">
		<h2><?php echo __('<em>PODCAST INSIDER</em> NEWS &amp; UPDATES', 'empowercast'); ?></h2>
		<?php empowercastadmin_community_news(4, true); ?>
	</div>

	<div class="clear"></div>
</div>
<?php
} // End empowercastadmin_welcome()

function empowercastadmin_edit_funding($FeedSettings = false, $feed_slug='podcast', $cat_ID=false)
{
    ...
    <h1 class="pp-heading"><?php echo __('Basic Show Information', 'empowercast'); ?></h1>
    <div class="pp-settings-section">
        <h2><?php echo __('Location', 'empowercast'); ?></h2>
        <label for="Feed[location]" class="pp-settings-label"><?php echo __('Optional', 'empowercast'); ?></label>
        <input class="pp-settings-text-input" type="text" name="Feed[location]" oninput="empowercast_locationInput(event)" value="<?php echo esc_attr($FeedSettings['location']); ?>" maxlength="50" />
        <label for="Feed[location]" class="pp-settings-label-under"><?php echo __('e.g. Cleveland, Ohio', 'empowercast'); ?></label>
        <div id="pp-location-details" class="pp-settings-subsection" <?php if (empty($FeedSettings['location'])) { echo "style=\"display: none;\""; } ?>>
            ...
            <label for="Feed[pci_geo]" class="pp-settings-label"><?php echo __('Geo', 'empowercast'); ?></label>
            <input class="pp-settings-text-input" type="text" name="Feed[pci_geo]" value="<?php echo esc_attr($FeedSettings['pci_geo']); ?>" maxlength="50" />
            <label for="Feed[pci_geo]" class="pp-settings-label-under"><?php echo __('e.g. geo:-27.86159,153.3169', 'empowercast'); ?></label>
            <br />
            <label for="Feed[pci_osm]" class="pp-settings-label"><?php echo __('OSM', 'empowercast'); ?></label>
            <input class="pp-settings-text-input" type="text" name="Feed[pci_osm]" value="<?php echo esc_attr($FeedSettings['pci_osm']); ?>" maxlength="50" />
            <label for="Feed[pci_osm]" class="pp-settings-label-under"><?php echo __('e.g. W43678282', 'empowercast'); ?></label>
        </div>
    </div>
    <div class="pp-settings-section">
        <h2><?php echo __('Episode Frequency', 'empowercast'); ?></h2>
        <div class="row ml-0 mr-0">
            ...
            <div class="form-check mr-4">
                ...
                <label class="form-check-label" for="weekly" style="color: black; font-size: 1rem;">
                    <?php echo __("Weekly", "empowercast"); ?>
                </label>
            </div>
            <div class="form-check">
                ...
                <label class="form-check-label" for="monthly" style="color: black; font-size: 1rem;">
                    <?php echo __("Monthly", "empowercast"); ?>
                </label>
            </div>
        </div>
        ...
        <div id="monthly-frequency" class="row ml-0 mr-0" style="margin-top: 20px; display: <?php echo !empty($FeedSettings['update_frequency']) && $FeedSettings['update_frequency'] == '3' ? '' : 'none' ?>;">
            <label class="mt-2 pp-settings-label" for="update_frequency_month">
                <?php echo __("Monthly Frequency", "empowercast"); ?>
            </label>
    ...
    <div class="pp-settings-section">
        <h2>
            <?php echo __('Credits', 'empowercast'); ?>
            <div class="pp-tooltip-right" style="height: 20px; width: 20px; margin: 1ch 0 0 1ch;">i
                <span class="text-pp-tooltip" style="top: -50%; min-width: 200px;"><?php echo esc_html(__('You can document your permanent host, co-host, engineer at the show level, etc. You should not duplicate credits at the episode level.', 'empowercast')); ?></span>
            </div>
        </h2>
            ...
            <div class="col-lg-12">
                ...
                for($i=0;$i<count($personNames); $i++) {
                    ...
                    <div id="role-<?php echo $currentPersonCount; ?>-container">
                        <div class="row">
                            <div class="col-lg-3">
                                <label for="role-<?php echo $currentPersonCount; ?>-name" style="margin: 0;"><?php echo __("Person", "empowercast"); ?></label>
                            </div>
                ...
                <button type="button" style="border: none; background: inherit; color: #1976D2;" id="newrole" name="newrole"><?php echo __("+ Add Role", "empowercast"); ?></button>
            </div>
        </div>
    </div>
    <div class="pp-settings-section">
        <h2>
            <?php echo __("Block", "empowercast"); ?>
        </h2>
        <h3 style="font-weight: bold;">
            <?php echo __("Before you Block", "empowercast"); ?>
        </h3>
        <p>
            <?php echo __("Be aware that blocking signals to specific sites that you do not want your podcast to be found there. However, not all services honor the block and you may have to manually request for your content to be removed from these platforms.", "empowercast"); ?>
        </p>
        <div style="display: flex; align-items: center; margin-top: 20px;">
            ...
            <label class="form-check-label" for="block" style="color: black; font-size: 1rem;">
                <?php echo __("I understand what blocking services/directories entails.", "empowercast"); ?>
            </label>
        </div>
        <div id="block-section" class="mt-2" style="display: <?php echo isset($FeedSettings["block"]) && intval($FeedSettings["block"]) == 1 ? "" : "none" ?>;">
            <div style="display: flex; align-items: center; margin-top: 20px;">
                ...
                <label class="form-check-label" for="block-all-check" style="color: black; font-size: 1rem;">
                    <?php echo __("I would like to block all directories.", "empowercast"); ?>
                </label>
            </div>
            <div class="row" id="block-list" style="margin-top: 20px; display: <?php echo isset($FeedSettings["block_all"]) && intval($FeedSettings["block_all"]) == 1 ? "none" : "" ?>;">
                ...
                <div class="col-md-6">
                    <h4 style="font-weight: bold;">
                        <?php echo __("Directories", "empowercast"); ?>
                    </h4>
                            ...
                            foreach ($existingBlockList as $blockDir) { ?>
                                <div id="block-<?php echo $blockDir?>">
                                    <div class="row" style="padding-left: 5%; padding-right: 5%; display: flex; justify-content: space-between; align-items: center; border-bottom: 1px solid #ddd;">
                                        <h4 style="margin: 0;">
                                            <?php echo __($blockDir, "empowercast"); ?>
                                        </h4>
...
<!--  Donate link and label -->
    <div class="pp-settings-section">
        <h2><?php echo __('Donate Link', 'empowercast'); ?> </h2>
        ...
        <div class="pp-settings-subsection">
	        <p class="pp-main"><?php echo __('Syndicate a donate link with your podcast. Create your own crowdfunding page with PayPal donate buttons, or link to a service such as Patreon.', 'empowercast'); ?></p>
        </div>
        <br />
	    <label for="donate_url" class="pp-settings-label"><?php echo __('Donate URL', 'empowercast'); ?></label>
	    ...
	    <label for="donate_label" class="pp-settings-label"><?php echo __('Donate Label', 'empowercast'); ?></label>
        ...
        <label for="donate_label" class="pp-settings-label-under"><?php echo __('optional', 'empowercast'); ?></label>
	    <p class="pp-settings-text" style="margin-top: 1em;"><a href="https://podopshost.com/support/empowercast-documentation/syndicating-a-donate-link-in-your-podcast/" target="_blank"><?php echo __('Learn more about syndicating donate links for podcasting', 'empowercast'); ?></a></p>
    </div>
    <script>
            ...
            jQuery("[name='newrole']").click(function (e) {
                ...
                if (jQuery("[name='role-" + currentRoleCount + "-name']").length) {
                    ...
                    let newHTML = '<div id="role-' + currentRoleCount + '-container">' +
                        '<div class="row">' +
                        '<div class="col-lg-3">' +
                        '<label for="role-' + currentRoleCount + '-name" style="margin: 0;"><?php echo __("Author/Artist", "empowercast"); ?></label>' +
                        '</div>' +
                        '<div class="col-lg-2" style="padding: 0;">' +
                        '<label for="role-' + currentRoleCount + '-role" style="margin: 0;"><?php echo __("Role", "empowercast"); ?></label>' +
                        '</div>' +
                        '<div class="col-lg-3">' +
                        '<label for="role-' + currentRoleCount + '-personurl" style="margin: 0;"><?php echo __("Person Image URL", "empowercast"); ?></label>' +
                        '</div>' +
                        '<div class="col-lg-3">' +
                        '<label for="role-' + currentRoleCount + '-linkurl" style="margin: 0;"><?php echo __("Link URL", "empowercast"); ?></label>' +
                        '</div>' +
                        '<div class="col-lg-1"></div>' +
                        '</div>' +
                        '<div class="row" style="display: flex; align-items: center;">' +
...
function empowercastadmin_edit_tv($FeedSettings = false, $feed_slug='podcast', $cat_ID=false)
{
	if( !isset($FeedSettings['parental_rating']) )
		$FeedSettings['parental_rating'] = '';

?>
<h1 class="pp-heading"><?php echo __('Rating Settings', 'empowercast'); ?></h1>
<p class="pp-settings-text"><?php echo sprintf(__('A parental rating is used to display your content on %s applications available on Internet connected TV\'s. The TV Parental Rating applies to both audio and video media.', 'empowercast'), '<strong><a href="http://www.podopshost.com/roku_podops/" target="_blank">Podops</a></strong>'); ?></p>
<div class="pp-settings-section" style="border-left: none;">
    <h2><?php echo __('Parental Rating', 'empowercast'); ?>  </h2>
	<?php
	$Ratings = array(''=>__('No rating specified', 'empowercast'),
			'TV-Y'=>__('Children of all ages', 'empowercast'),
			'TV-Y7'=>__('Children 7 years and older', 'empowercast'),
			'TV-Y7-FV'=>__('Children 7 years and older [fantasy violence]', 'empowercast'),
			'TV-G'=>__('General audience', 'empowercast'),
			'TV-PG'=>__('Parental guidance suggested', 'empowercast'),
			'TV-14'=>__('May be unsuitable for children under 14 years of age', 'empowercast'),
			'TV-MA'=>__('Mature audience - may be unsuitable for children under 17', 'empowercast')
		);
	$RatingsTips = array(''=>'',
				'TV-Y'=>__('Whether animated or live-action, the themes and elements in this program are specifically designed for a very young audience, including children from ages 2-6. These programs are not expected to frighten younger children.  Examples of programs issued this rating include Sesame Street, Barney & Friends, Dora the Explorer, Go, Diego, Go! and The Backyardigans.', 'empowercast'),
				...
				'TV-Y7-FV'=>__('When a show has noticeably more fantasy violence, it is assigned the TV-Y7-FV rating. Action-adventure shows such Pokemon series and the Power Rangers series are assigned a TV-Y7-FV rating.', 'empowercast'),
				'TV-G'=>__('Although this rating does not signify a program designed specifically for children, most parents may let younger children watch this program unattended. It contains little or no violence, no strong language and little or no sexual dialogue or situation. Networks that air informational, how-to content, or generally inoffensive content.', 'empowercast'),
				'TV-PG'=>__('This rating signifies that the program may be unsuitable for younger children without the guidance of a parent. Many parents may want to watch it with their younger children. Various game shows and most reality shows are rated TV-PG for their suggestive dialog, suggestive humor, and/or coarse language. Some prime-time sitcoms such as Everybody Loves Raymond, Fresh Prince of Bel-Air, The Simpsons, Futurama, and Seinfeld  usually air with a TV-PG rating.', 'empowercast'),
				'TV-14'=>__('Parents are strongly urged to exercise greater care in monitoring this program and are cautioned against letting children of any age watch unattended. This rating may be accompanied by any of the following sub-ratings:', 'empowercast'),
				'TV-MA'=>__('A TV-MA rating means the program may be unsuitable for those below 17. The program may contain extreme graphic violence, strong profanity, overtly sexual dialogue, very coarse language, nudity and/or strong sexual content. The Sopranos is a popular example.', 'empowercast')
		);
...
function empowercastadmin_edit_artwork($FeedSettings, $General)
{
	$SupportUploads = empowercastadmin_support_uploads();
?>

<h1 class="pp-heading"><?php echo __('Podcast Artwork', 'empowercast'); ?></h1>


<div class="pp-settings-section">
    <h2><?php echo __('Podcast Artwork', 'empowercast'); ?></h2>
    <label for="Feed[itunes_image]" class="pp-settings-label"><?php echo __('Artwork URL', 'empowercast'); ?></label>
    ...
    <label for="Feed[itunes_image]" class="pp-settings-label-under"><?php echo __('Apple Podcast image must be at least 1400 x 1400 pixels in .jpg or .png format. Apple Podcast image must not exceed 3000 x 3000 pixels and must use RGB color space. The filesize should not exceed 0.5MB.', 'empowercast'); ?></label>
        ...
        <div>
            <div class="pp-settings-button">
                <label class="pp-settings-button-label" for="itunes_image_file">
                    <img class="pp-settings-icon" src="<?php echo empowercast_get_root_url(); ?>images/cloud_up.svg" alt="">
                    <?php echo __('Upload Image', 'empowercast'); ?>
                </label>
                <input type="file" id="itunes_image_file" name="itunes_image_file" accept="image/*" class="pp_file_upload" style="display: none" />
            </div>
        </div>
    </div>
        <!--<a href="#" onclick="javascript: window.open( document.getElementById('itunes_image').value ); return false;"><?php echo __('preview', 'empowercast'); ?></a>-->
    <?php } ?>
</div>
...
function empowercastadmin_edit_destinations($FeedSettings, $General, $FeedAttribs)
{
