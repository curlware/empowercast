...
$FeedSettings = empowercast_get_settings('empowercast_feed_podcast');
$GeneralSettings = empowercast_get_settings('empowercast_general');
$blogEmail = empowercast_get_settings('admin_email');
...
if (isset($_FILES['itunes_image_file'])) {
    ...
    if (!in_array(strtolower($ext), $acceptable_extensions)) {
        empowercast_page_message_add_error(__('Image has an invalid file type: ' . htmlspecialchars($ext), 'empowercast') );
        $error = true;
    } else {
        // Check the image...
        if (file_exists($temp)) {
            ...
            if (is_array($upload_result) && isset($upload_result['error'])) {
                empowercast_page_message_add_error(__('Error saving Apple Podcasts image', 'empowercast') . ':	' . $upload_result['error']);
                $error = true;
            } elseif (is_array($upload_result) && isset($upload_result['url'])) {
                $previewImageURL = $upload_result['url'];
            } else {
                empowercast_page_message_add_error(__('Error saving Apple Podcasts image', 'empowercast'));
                $error = true;
            }
        }
    }
...
if (isset($_POST['pp_start']['title'])) {
    $SaveSettings = empowercast_stripslashes($_POST['pp_start']);
    if (isset($previewImageURL)) {
        unset($SaveSettings['itunes_image']);
        $SaveSettings['itunes_image'] = $previewImageURL;
    }
    empowercast_save_settings($SaveSettings, 'empowercast_feed_podcast');
...
<div class="wrap">
    <div class="pp_container" style="padding-bottom: 0">
        <div class="onboarding_header">
            <h4 style="margin: 0;"><?php echo __('Create your Podcast', 'empowercast'); ?></h4>
            <h5 style="margin: 0;"><?php echo __('Enter your new podcast\'s information and contact email.', 'empowercast'); ?></h5>
        </div>
                ...
                <div class="pp_flex-grid">
                    <div class="pp_col" style="margin-left: 0;">
                        <form id="basic-feed" enctype="multipart/form-data" action="" method="post">
                            <h4 style="margin-bottom: 2ch;"><?php echo __('Podcaster Information', 'empowercast'); ?></h4>
                            <div style="width: 200%;">
                                <div class="pp_form-group" style="display: inline-block; width: 40%;">
                                    <div class="pp_input-field-thirds">
                                        <input id="input-name" style="width: 90%;" type="text" name="pp_start[name]" class="pp_outlined" value="<?php echo htmlspecialchars($talent_name); ?>" placeholder="<?php echo __('Enter the name of the podcast host', 'empowercast'); ?>">
                                        <label for="input-name" id="name-label" style="left: 4px;"><?php echo __('Name', 'empowercast'); ?></label>
                                        <script>
                                ...
                                <div class="pp_form-group" style="display: inline-block; width: 40%;">
                                    <div class="pp_input-field-thirds">
                                        <input id="input-email" style="width: 90%;" type="text" name="pp_start[email]" class="pp_outlined" value="<?php echo htmlspecialchars($blogEmail); ?>" placeholder="<?php echo __('Enter the email for your podcast', 'empowercast'); ?>">
                                        <label for="input-email" id="email-label" style="left: 4px;"><?php echo __('Email', 'empowercast'); ?></label>
                                        <script>
                            ...
                            <h4 style="margin-bottom: 2em;"><?php echo __('Podcast Information', 'empowercast'); ?></h4>
                            <div class="">
                                <div class="pp_form-group">
                                    <div class="pp_input-field-thirds">
                                        <input id="input-title" type="text" name="pp_start[title]" class="pp_outlined" value="<?php echo esc_attr($title); ?>" placeholder="<?php echo __('Enter the title of your podcast', 'empowercast'); ?>">
                                        <label for="input-title" id="title-label"><?php echo __('Show Name', 'empowercast'); ?></label>
                                        <script>
                            ...
                            <div>
                                <div>
                                    <div class="pp_input-field-thirds">
                                        <textarea id="podcast-description" type="text" name="pp_start[description]" class="pp_outlined" placeholder="<?php echo __('Enter a brief description of your show.', 'empowercast'); ?>"><?php echo htmlspecialchars($feed_desc); ?></textarea>
                                        <label style="left: -3px;" for="podcast-description" id="description-label"><?php echo __('Show Description', 'empowercast'); ?></label>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div class="pp_form-group" style="display: inline-block;">
                                    <div class="pp_input-field-thirds" style="width: ">
                                        ...
                                        <label for="apple_cat" style="left: 3px;"><?php echo __('Category','empowercast'); ?></label>
                                    </div>
                                </div>
                                <div class="pp_form-group" style="display: inline-block; margin-left: 2em;">
                                    <p class="label"><?php echo __('Explicit Content','empowercast'); ?></p>
                                    <label><input type="radio" class="explicit-radio" name="pp_start[itunes_explicit]" value="1" <?php echo $explicit == 1 ? 'checked': '' ?> /> <?php echo __('Yes', 'empowercast'); ?></label>
                                    <label style="margin-left:2em;"><input type="radio" class="explicit-radio" name="pp_start[itunes_explicit]" value="2" <?php echo $explicit == 2 ? 'checked': '' ?> /> <?php echo __('No', 'empowercast'); ?></label>
                                </div>
                            </div>
                            <button type="submit" name="basic-feed-submit" class="pp_button" style="visibility: hidden;"><span><?php echo __('Continue', 'empowercast'); ?></span></button>
                        </form>
                    </div>
                    ...
                    <div id="artwork-onboarding-container" class="pp_col" style="">
                        <form id="artwork" enctype="multipart/form-data" action="" method="post">
                            <div style="margin-left: 3em;">
                                <div id="error-container" style="display: none;"><h5 style="font-weight: bold;color: red;"><img style="vertical-align: middle;margin: 0 5px 3px 0;" src="<?php echo empowercast_get_root_url(); ?>images/onboarding/cancel.svg"><?php echo __('Your image is not valid.', 'empowercast'); ?></h5></div>

                                <div style="margin-bottom: 1ch;">
                                    <p class="label" style="margin-bottom: 0;"><?php echo __('Podcast Artwork','empowercast'); ?></p>
                                    <p style="display: inline-block; font-size: 12px; margin: 0 2em 0 0;"><?php echo __('Do you have Podcast Artwork?', 'empowercast'); ?></p>
                                    <label><input type="radio" class="artwork-radio" name="pp_start[itunes_explicit]" value="1" <?php echo !empty($FeedSettings['itunes_image']) ? 'checked': '' ?> /> <?php echo __('Yes', 'empowercast'); ?></label>
                                    <label style="margin-left:2em;"><input type="radio" class="artwork-radio" name="pp_start[itunes_explicit]" value="0" <?php echo empty($FeedSettings['itunes_image']) ? 'checked': '' ?> /> <?php echo __('No', 'empowercast'); ?></label>
                                </div>
                                <div id="pp-artwork-onboarding-message"<?php echo !empty($FeedSettings['itunes_image']) ? ' style="display: none;"' : ''; ?>>
                                    <p style="font-size: 11px;"><?php echo __('You don’t need artwork to start a podcast, but you will need it to submit your show to distributors like Apple Podcasts.', 'empowercast'); ?>
                                        <a href="https://podopshost.com/support/empowercast-documentation/artwork-2/"><?php echo __('Learn more', 'empowercast'); ?></a>
                                    </p>
                                </div>
                                <div id="pp-artwork-upload-container"<?php echo empty($FeedSettings['itunes_image']) ? ' style="display: none;"' : ''; ?>>
                                    <div>
                                        <div id="upload-artwork-button" onclick="document.getElementById('FileAttachment').click();">
                                            <img style="color: #3c434a; vertical-align: middle; height: 20px; margin-right: 6px;" src="<?php echo empowercast_get_root_url(); ?>images/onboarding/image.svg" />
                                            <span style="vertical-align: middle; line-height: 24px;"><?php echo __('Upload Artwork', 'empowercast'); ?></span>
                                    ...
                                    <div class="pp_flex-grid" id="showbasics_artwork">
                                        <div class="pp_col" id="showbasics_artwork_upload" style="margin-left: 0; flex: 0.5;">
                                            ...
                                            <?php
                                            if (!isset($previewImageURL)) {
                                                $previewImageURL = !empty($FeedSettings['itunes_image']) ? $FeedSettings['itunes_image'] : empowercast_get_root_url() . "itunes_default.jpg";
                                            } ?>
                                        ...
                                        <div class="pp_col" style="margin: 0;">
                                            <div id="artwork-spec">
                                                <strong><?php echo __('Artwork Requirements', 'empowercast'); ?></strong><br />
                                                <img style="display: none;" src="<?php echo empowercast_get_root_url(); ?>images/onboarding/checkmark.svg" id="size-icon" class="success-fail-icon">
                                                <p class="pp-smaller-text"><?php echo __('Minimum size: 1400px x 1400px', 'empowercast'); ?></p> <br />
                                                <img style="display: none;" src="<?php echo empowercast_get_root_url(); ?>images/onboarding/checkmark.svg" id="type-icon" class="success-fail-icon">
                                                <p class="pp-smaller-text"><?php echo __('.jpg or .png', 'empowercast'); ?></p> <br />
                                                <img style="display: none;" src="<?php echo empowercast_get_root_url(); ?>images/onboarding/checkmark.svg" id="colorspace-icon" class="success-fail-icon">
                                                <p class="pp-smaller-text"><?php echo __('RGB color space', 'empowercast'); ?></p> <br />
                                                <a href="https://podopshost.com/support/empowercast-documentation/artwork-2/"><?php echo __('Learn more about Podcast Artwork', 'empowercast'); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <button type="submit" name="artwork-submit" class="pp_button" style="padding: 0; visibility: hidden;"><span><?php echo __('Continue', 'empowercast'); ?></span></button>
                        </form>
                        <div class="pp_col">
                            <div class="pp_button-container" id="show_basics_continue" style="">
                                <button id="continue-button" type="button" name="submit" class="pp_button"><span><?php echo __('Continue', 'empowercast'); ?></span></button>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    function verifyImage() {
        ...
        img.onload = function() {
            ...
            if (width != height || width > 3000 || width < 1400) {
                ...
                jQuery("#size-icon").attr('src', '<?php echo empowercast_get_root_url(); ?>images/onboarding/cancel.svg');
            }
            ...
            if (!url.toLowerCase().includes('.jpg') && !url.toLowerCase().includes('.png')) {
                ...
                jQuery("#type-icon").attr('src', '<?php echo empowercast_get_root_url(); ?>images/onboarding/cancel.svg')
            }
    ...
    jQuery(document).ready(function() {
        jQuery("#filePath").val(jQuery("#preview_image").attr('src').replace(/https?:\/\/.*\/uploads\/empowercast\//i, ''));
