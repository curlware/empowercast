...
<head>
    <link href="https://assets.podopshost.com/css/podopsicons.css" rel="stylesheet" type="text/css"/>
    <link href="https://assets.podopshost.com/tests/colorbox.css" rel="stylesheet" type="text/css"/>
    <link href="https://assets.podopshost.com/css/ekko-lightbox.css" rel="stylesheet" type="text/css"/>
    <link href="https://assets.podopshost.com/css/ekko-lightbox.min.css" rel="stylesheet" type="text/css"/>
    <link href="https://assets.podopshost.com/css/podopsicons.css" rel="stylesheet" type="text/css"/>
    <link href="<?php if (isset($_SERVER['HTTPS'])) {
        echo 'https://' . $_SERVER['SERVER_NAME'] . '/wp-content/plugins/empowercast-directory/js/mediaelement/build/mediaelementplayer.min.css';
    } else {
        echo 'http://' . $_SERVER['SERVER_NAME'] . '/wp-content/plugins/empowercast-directory/js/mediaelement/build/mediaelementplayer.min.css';
    } ?>" rel="stylesheet" type="text/css"/>

    <script src="https://assets.podopshost.com/js/ekko-lightbox.js"></script>
    <script src="https://assets.podopshost.com/js/ekko-lightbox.min.js"></script>
    <script src="https://assets.podopshost.com/js/jquery.colorbox.js"></script>
    <script src="https://assets.podopshost.com/js/jquery.colorbox-min.js"></script>
    <script src="<?php if (isset($_SERVER['HTTPS'])) {
        echo 'https://' . $_SERVER['SERVER_NAME'] . '/wp-content/plugins/empowercast-directory/js/mediaelement/build/mediaelement-and-player.js';
    } else {
        echo 'http://' . $_SERVER['SERVER_NAME'] . '/wp-content/plugins/empowercast-directory/js/mediaelement/build/mediaelement-and-player.js';
    } ?>"></script>
    <meta charset="utf-8">
</head>
<div>
...
<div class="program-container">
        ...
        <div class="grid-container">
            ...
            <div class="coverart">
                <img class="coverart"
                     src="<?php if (isset($props[0]->program_header_image)) {
                         echo("https://assets.podopshost.com/coverart/300/{$props[0]->program_id}.jpg");
                     } else {
                         echo("https://assets.podopshost.com/coverart/300/default.jpg");
                     } ?>"
                >
            </div>
            <div class="share-icons display-inline-block">
                <a id="subscribe" href="" class="text-decoration-none" data-toggle="lightbox" data-title="Subscribe" data-gallery="remove-load" data-width="1200">
                    <i id="subscribe" class="podops-icon bicon-rss ppn-subscribe-style" ></i>
                ...
                <a id="share" href="<?php echo htmlspecialchars($_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] . $_SERVER['QUERY_STRING']); ?>" class="text-decoration-none" data-toggle="lightbox" data-title="Share" data-gallery="remove-load" data-width="1200">
                    <i class="podops-icon bicon-share ppn-share-style" onclick="SetShareOptions(<?php echo $props[0]->program_rssurl; ?>,<?php echo $props[0]->program_title; ?>)"></i>
    ...
    <div class="description bold">
        ...
        <a class="ppn-claim-style" id="claim" href="https://www.podopshost.com" data-toggle="lightbox" data-title="Claim" data-gallery="remove-load" data-width="1200">Claim This Show</a>
    </div>
                    ...
                    <div class="playbuttoncontainer">
                        <a href="<?php echo($props[$i]->podcast_filename); ?>">
                            <img class="playbutton" src="<?php if (isset($_SERVER['HTTPS'])) {
                                echo 'https://' . $_SERVER['SERVER_NAME'] . '/wp-content/plugins/empowercast-directory/images/ShowPageRedesignPlayButton.png';
                            } else {
                                echo 'http://' . $_SERVER['SERVER_NAME'] . '/wp-content/plugins/empowercast-directory/images/ShowPageRedesignPlayButton.png';
                            } ?>"
                        </a>
                    </div>
